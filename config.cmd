...
IF /i NOT "%CONFIG_CONFIG_BLK%"=="#NONE" (
	CALL ccs.bat /send /key-nblk-changeval %CONFIG_CONFIG_KEY% %CONFIG_CONFIG_KEY_VAL%
	GOTO :CONFIG-END
)
	
CALL ccs.bat /send /key-changeval %CONFIG_CONFIG_BLK% %CONFIG_CONFIG_KEY% %CONFIG_CONFIG_KEY_VAL%
